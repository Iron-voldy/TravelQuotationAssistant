    ...
    return (
        <AppLayout>
            ...
            <div className="page-header">
                ...
                <p className="page-subtitle">Track and manage your travel quotations</p>
            </div>
            ...
            <div className="glass-card">
                <div className="table-header">
                    <h2 className="table-title">My Quotations</h2>
                ...
                {loading ? (
                    ...
                    <div className="empty-state">
                        ...
                        <p>Go to AI Chat to create your first travel quotation</p>
                    </div>
                ) : (
                    <>
