...
const RegisterPage = () => {
  ...
  // Random background images for branding section
  const backgroundImages = [
    'https://images.unsplash.com/photo-1488646953014-85cb44e25828?w=1200', // Travel suitcase
    'https://images.unsplash.com/photo-1436491865332-7a61a109cc05?w=1200', // Airplane wing
    'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=1200', // Beach
    'https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?w=1200', // Mountain travel
    'https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?w=1200', // Lake view
    'https://images.unsplash.com/photo-1530789253388-582c481c54b0?w=1200', // City travel
  ];
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      ...
      // In production, make API call to register user
